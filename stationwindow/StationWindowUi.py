...
class StationWindowUi(object):
    def setupUi(self, Form):
        ...
        self.label_14.setGeometry(QtCore.QRect(350, 440, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.lbl_package_count = QtWidgets.QLabel(Form)
        self.lbl_package_count.setGeometry(QtCore.QRect(500, 440, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.lbl_package_count.setFont(font)
        self.lbl_package_count.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lbl_package_count.setObjectName("lbl_package_count")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_14.setText(_translate("Form", "Package count:"))
        self.lbl_package_count.setText(_translate("Form", "0"))
